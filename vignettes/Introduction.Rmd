...
Occasionally we may require to customize our `$clone()` method. When cloning we
may have to make changes to the copy or the original, for instance due to managing
unique files associated to objects or updating references to other objects.
