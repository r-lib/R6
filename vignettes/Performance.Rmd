...
This is a simpler implementation of reference objects, from the [testclasses](https://github.com/wch/testclasses) package.
...
Instead of `self`, these objects have `public` and `private` object.
...
D is slower than E, though I'm not sure why. The only difference is that the returned object has a class attribute, and R shouldn't have to do any S3 method lookup, since the object returned by the instantiation function is simply discarded.
