...
<!-- badges: start -->
[![Travis build status](https://travis-ci.org/r-lib/R6.svg?branch=master)](https://travis-ci.org/r-lib/R6)
[![CRAN status](https://www.r-pkg.org/badges/version/R6)](https://CRAN.R-project.org/package=R6)
<!-- badges: end -->
